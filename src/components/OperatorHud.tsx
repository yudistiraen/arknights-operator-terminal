    ...
    <div className="bottom-info absolute bottom-3 left-4 md:bottom-6 md:left-8 z-30">
      ...
      <div className="flex items-center gap-2 mb-1.5 md:mb-3 flex-wrap">
        ...
        {operator.tags.map((tag) => (
          <span
            key={tag}
            className="font-display text-[8px] md:text-[10px] text-white/50 tracking-wider uppercase bg-white/5 border border-white/10 px-1.5 md:px-2 py-0.5 md:py-1 backdrop-blur-sm"
          >
            {tag}
          </span>
        ))}
